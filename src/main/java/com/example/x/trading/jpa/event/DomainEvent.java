...
public abstract class DomainEvent<T extends Serializable> implements Event {
    ...
    public String getTopicName() {
        String[] eventNamesSplit = StringUtils.splitByWholeSeparator(this.getClass().getSimpleName(), "$");
        String stringBuilder = "blinklink" + "." + "io" + "." + "global" + "." + this.getAggregateType().getSimpleName().toLowerCase() + "." + eventNamesSplit[0].toLowerCase();
